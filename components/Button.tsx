...
export default function Button({
  ...
  const css =
    variant === "secondary"
      ? `rounded-[3px] inline-flex items-center justify-center bg-white dark:bg-transparent border border-primary px-2 md:h-10 h-[30px] text-sm transition-colors hover:bg-zinc-300 dark:hover:bg-zinc-700 dark:hover:text-white focus:bg-primary-dark focus:text-white focus:outline-none disabled:cursor-not-allowed md:px-4 ${className}`
